...
type ServiceKey = 'landing' | 'corporate' | 'ecommerce' | 'advertising';

interface ServiceTypes {
	landing: ServiceType;
	corporate: ServiceType;
	ecommerce: ServiceType;
	advertising: ServiceType;
}
...
export default function Services(): JSX.Element {
	...
	const toggleServiceType = (service: ServiceKey) => {
	...
	const services: ServiceKey[] = ['landing', 'corporate', 'ecommerce', 'advertising'];
